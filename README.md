...
The website will host multiple joinable "worlds", which users can create and invite each other to use game pins, like in Kahoot or Among Us.
Users can join these worlds synchronously or asynchronously. Once a world is created, its invited users can influence them at any time, even if the hosting user is offline.
